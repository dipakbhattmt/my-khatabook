...
return [
    ...
    */
    ...
    'custom' => [
        'amount' => [
            'required' => 'חובה לכתוב מה סכום התשלום.',
        ],
        'budget' => [
            'required' => 'חובה לבחור תקציב וחובה שיהיה לפחות שקל אחד.',
        ],
        'type_id' => [
            'required' => 'חובה לבחור את סוג התשלום.'
        ],
        'paid_at' => [
            'required' => 'חובה לבחור מתי זה שולם.'
        ],
        'method_id' => [
            'required' => 'חובה לבחור את אופן התשלום.'
        ]
    ],
